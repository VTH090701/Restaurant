                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    ?>
                                    <form action="{{ url('/fogret-auth') }}" method="POST">
                                        @csrf
                                        <div class="mb-3" style="color: white;">
                                            Vui lòng nhập email mà bạn đã đăng ký tài khoản trong hệ thống của chúng
                                            tôi.
                                        </div>
                                        <div class="row g-3">
                                            <div class="col-md-12">
                                                <div class="form-floating">
                                                    <input type="email" class="form-control" id="nv_email"
                                                        name="nv_email" placeholder="Nhập email">
                                                    <label for="email"></label>
                                                </div>
                                                @error('nv_email')
                                                    <div class="text-sm " style="color: red">Email người đặt không được để
                                                        trống</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <button class="btn btn-primary w-100 py-3" type="submit">Gửi email xác
                                                    nhận</button>
                                            </div>
